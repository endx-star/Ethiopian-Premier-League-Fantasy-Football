...
class MfListproWidget extends StatefulWidget {
  const MfListproWidget({Key key}) : super(key: key);

  @override
  _MfListproWidgetState createState() => _MfListproWidgetState();
}

class _MfListproWidgetState extends State<MfListproWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
        backgroundColor: Color(0xFF0E093C),
                    ...
                    children: [
                      FutureBuilder<ApiCallResponse>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final columnMFListResponse = snapshot.data;
                          return Builder(
                            builder: (context) {
                              final kit = getJsonField(
                                    (columnMFListResponse?.jsonBody ?? ''),
                                    r'''$.data.doc[*].club[*]''',
                                  )?.toList() ??
                                  [];
                              return Column(
