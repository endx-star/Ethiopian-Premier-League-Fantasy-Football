...
class DefListProWidget extends StatefulWidget {
  const DefListProWidget({Key key}) : super(key: key);

  @override
  _DefListProWidgetState createState() => _DefListProWidgetState();
}

class _DefListProWidgetState extends State<DefListProWidget> {
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Builder(
                        builder: (context) {
                          ...
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                            children: List.generate(price.length, (priceIndex) {
